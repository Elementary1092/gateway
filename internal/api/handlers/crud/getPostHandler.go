...
func NewGetPostHandler(logger *logging.Logger, client services.CRUDServiceClient) http.Handler {
...
// GET /posts/{id:[0-9]+}
func (g *getPostHandler) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
